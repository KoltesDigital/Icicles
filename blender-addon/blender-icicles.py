...
bl_info = {
    ...
    "description": "For the production of the demo Icicles.",
    "warning": "",
...
def save_post(context):
    ...
    bpy.ops.html5_animations.export(
        ...
        js_variable_name=addon_prefs.js_variable_name,
...
OrientationHelper = orientation_helper_factory("IcilesOrientationHelper", axis_forward='-Z', axis_up='Y')
...
class WebSocketServerSettings(AddonPreferences, OrientationHelper):
    ...
    filepath = StringProperty(
        name="File to save to (JS)",
        description="Listen on host:port",
        default="//../src/animations/icicles.js"
    )
